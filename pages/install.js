...
function install(){
    ...
    async function fetchScriptTags(){
        ...
        const {data} = await axios.get(`https://21d5-45-59-35-96.ngrok.io/script_tag/all`);
    ...
    async function handleAction(){
        ...
        if(!isInstalled){
            axios.post('https://21d5-45-59-35-96.ngrok.io/script_tag');
        }else{
            axios.delete(`https://21d5-45-59-35-96.ngrok.io/script_tag/?id=${scriptTagId}`);
        }
